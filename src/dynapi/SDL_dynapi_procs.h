...
SDL_DYNAPI_PROC(int,SDL_Vulkan_GetInstanceExtensions,(unsigned int a, const char **b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_Vulkan_CreateSurface,(SDL_Window *a, VkInstance b, VkSurfaceKHR *c),(a,b,c),return)
