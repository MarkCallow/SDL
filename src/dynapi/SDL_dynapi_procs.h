...
SDL_DYNAPI_PROC(int,SDL_GetVulkanInstanceExtensions,(unsigned int a, const char **b),(a,b),return)
SDL_DYNAPI_PROC(int,SDL_CreateVulkanSurface,(SDL_Window *a, VkInstance b, VkSurfaceKHR *c),(a,b,c),return)
